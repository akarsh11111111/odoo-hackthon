...
class Vehicle(Document):
    ...
    class Settings:
        name = "vehicles"
        indexes = [
            IndexModel([("is_active", ASCENDING), ("status", ASCENDING)], name="vehicle_active_status_idx"),
            IndexModel([("region", ASCENDING), ("status", ASCENDING)], name="vehicle_region_status_idx"),
        ]
